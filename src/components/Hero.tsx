...
export default function Hero() {
  return (
    <div className="relative  bg-gradient-to-r from-purple-900 to-indigo-800 text-white overflow-hidden">
      ...
      <div className="container px-20 py-10 md:py-20 lg:py-24 lg:px-40 relative">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
              <Link to="/start">
                <Button
                  size="lg"
                  className="w-full sm:w-auto bg-neutral-50 text-neutral-800 hover:bg-neutral-100 shadow-lg hover:shadow-xl transition-all"
                >
                  Start my approval
                </Button>
              </Link>
          ...
          <div className="relative h-[400px] md:h-[500px]">
            ...
            <motion.div
              ...
              className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 -rotate-12 z-0 w-[280px] h-[500px] md:w-[320px] md:h-[580px]"
              style={{ filter: 'blur(6px)' }}
              aria-hidden="true"
            >
              <div className="w-full h-full bg-gradient-to-br from-gray-900/80 to-black/80 rounded-[40px] shadow-2xl" />
            </motion.div>
            <motion.div
              initial={{ opacity: 0, scale: 0.9 }}
